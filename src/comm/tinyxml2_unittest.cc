...
//TODO colin's test
//Get All Child Element Node whose parents name is 'name'
//childs vector is clear inside.Caller must guarantee doc is 
//init.
void XMLGetAllChilds(XMLDocument& doc, const std::string& name, std::vector<XMLElement*>& childs) {
}
